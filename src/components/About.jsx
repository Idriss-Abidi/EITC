...
const About = () => {
  return (
    <div id="ABOUT" className="border-b border-neutral-900 pb-4">
      <motion.h1 whileInView={{opacity:1, y:0}} initial={{opacity:0, y:-50}} transition={{duration:0.5}} className="my-20 text-center text-4xl text-neon">ABOUT <span className="text-neutral-500 us-neon">US</span></motion.h1>
