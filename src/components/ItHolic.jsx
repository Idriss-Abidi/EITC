...
const ItHolic = () => {
  ...
  return (
    <div id="ITHOLIC" className="border-b border-neutral-900 pb-4 m-0">
      <motion.h2
      ...
      <p
        ...
        style={{ fontFamily: '"Share Tech", sans-serif' }}
      >
        IT Holic is a hub for anyone obsessed with and passionate about technology
        <br /> and computing. Each year, we explore different themes and challenges in the world of IT.
      </p>
