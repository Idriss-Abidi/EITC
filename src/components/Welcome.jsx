        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2"> 
                <div className="flex flex-col items-center lg:items-start">
                    <motion.h1 variants={container1(0)} initial="hidden" id="eitc" animate="visible" className="my-20 pr-[30px] text-7xl lg:text-8xl">EITC</motion.h1>
                    <motion.span variants={container1(0.5)} initial="hidden" id="eitcn" animate="visible" className="my-1 pr-[30px] text-2xl lg:text-2xl">ENSIAS IT CLUB</motion.span>
